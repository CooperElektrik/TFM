...
execute if score @s increment matches 39 if data storage tf:branch {meal:0} run function tf:interaction/night/exit
execute if data storage tf:branch {meal:1} if data storage tf:branch {assure:1} if score @s increment matches 53.. run function tf:interaction/night/exit