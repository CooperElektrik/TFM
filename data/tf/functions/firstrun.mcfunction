...
tellraw @a {"text": "Using the default player name of -. Change it by /data modify storage tf:player.data player.name set value <your name>"}
data modify storage tf:player.data player.name set value -
