...
## Dinner
data modify storage tf:dialogue.player dinner.intro.line1 set value "The sun has already set."
data modify storage tf:dialogue.player dinner.intro.line2 set value "I guess I'll make dinner soon..."
data modify storage tf:dialogue.player dinner.intro.line3 set value "I tell Sylvie to sit at the table."
data modify storage tf:dialogue.player dinner.intro.line4 set value "Now, what shall I do about Sylvie's dinner?"
data modify storage tf:dialogue.player dinner.intro.line5 set value "I don't want to waste any money."
data modify storage tf:dialogue.player dinner.intro.line6 set value "Bread and water is plenty."
data modify storage tf:dialogue.player dinner.intro.line7 set value "Sylvie begins eating the food that was given to her..."
data modify storage tf:dialogue.player dinner.intro.line8 set value "I'll start making meals for two from now on."
data modify storage tf:dialogue.player dinner.intro.line9 set value "It's no trouble making an extra portion."
data modify storage tf:dialogue.player dinner.intro.line10 set value "She doesn't seem to think that the food placed in front of her is for herself."
data modify storage tf:dialogue.player dinner.intro.line11 set value "Sylvie nervously picks up the fork and begins eating awkwardly."
data modify storage tf:dialogue.player dinner.intro.line12 set value "Her expression is stiff, and it doesn't seem like she is enjoying the meal."
data modify storage tf:dialogue.player dinner.intro.line13 set value "Sylvie looks troubled after she finished eating."
data modify storage tf:dialogue.player dinner.intro.line14 set value "It doesn't seem like she's telling a lie, but she's clearly anxious."
data modify storage tf:dialogue.player dinner.intro.line15 set value "She must be feeling confused due to the drastic change in treatment up until now."
data modify storage tf:dialogue.player dinner.intro.line16 set value "It's already evening. I should get ready for bed..."
data modify storage tf:dialogue.player dinner.intro.line17 set value "Her bedroom..."
data modify storage tf:dialogue.player dinner.intro.line18 set value "Fortunately, there's an empty room."
data modify storage tf:dialogue.player dinner.intro.line19 set value "The clinic is separate. This is an extra room and bed in case there is an emergency patient."
data modify storage tf:dialogue.player dinner.intro.line20 set value "She seems to think there's an ulterior motive behind the way she's being treated."
data modify storage tf:dialogue.player dinner.intro.line21 set value "She doesn't seem to completely trust what I said."
data modify storage tf:dialogue.player dinner.intro.line22 set value "I ignore her question and leave the room."
## Fever
...
data modify storage tf:dialogue.player fever.line20 set value ""
data modify storage tf:dialogue.player fever.line21 set value ""
data modify storage tf:dialogue.player fever.line22 set value ""
data modify storage tf:dialogue.player fever.line23 set value ""
data modify storage tf:dialogue.player fever.line24 set value ""
data modify storage tf:dialogue.player fever.line25 set value ""
data modify storage tf:dialogue.player fever.line26 set value ""
data modify storage tf:dialogue.player fever.line27 set value ""
data modify storage tf:dialogue.player fever.line28 set value ""
data modify storage tf:dialogue.player fever.line29 set value ""
data modify storage tf:dialogue.player fever.line30 set value ""
data modify storage tf:dialogue.player fever.line31 set value ""