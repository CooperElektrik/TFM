...
execute if score @s interaction matches 2 run function tf:interaction/intro/intro/choice/accept
execute if score @s interaction matches 3 run function tf:interaction/intro/intro/choice/decline
...
execute if score @s interaction matches 19 run function tf:interaction/lewd/m/handler
execute if score @s interaction matches 20 run function tf:interaction/intro/night/day0/choice/0/same
