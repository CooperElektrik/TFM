...
execute store result score @s trust-internal run data get storage tf:save trust-internal
execute store result score @s friendship run data get storage tf:save friendship
execute store result score @s lust run data get storage tf:save lust

tellraw @s {"text": "Rolled back to last savepoint.","color": "green"}